    ...
    <div className="toolbar">
      ...
      <div className="toolbar-right">
        <div className="tool-group">
          <button type="button" className="tool-btn" onClick={onCopyUrl} title="Copy URL">
            <Icon name="link" size={13} />
            Copy URL
          </button>
          <div className="tool-group-sep" />
          <button type="button" className="tool-btn" onClick={onCopyContent} title="Copy">
            <Icon name="copy" size={13} />
            Copy
          </button>
          <div className="tool-group-sep" />
          <button type="button" className="tool-btn" onClick={onSave} title="Save">
